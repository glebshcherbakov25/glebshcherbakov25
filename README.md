# Щербаков Глеб — **Data Analyst | Researcher** 👋  
...
Решаю широкий спектр аналитических задач — от **разработки ML-моделей** и **эконометрических прогнозов** до **автоматизации процессов** и **обработки больших массивов данных**.  
