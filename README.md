...
📊 Увлекаюсь аналитикой данных, Big Data и визуализацией  
📍 Москва, Россия  
...
Привет! Я Глеб, начинающий аналитик данных с интересом к статистике, визуализации и работе с большими данными. Учусь на направлении "Цифровая экономика" в РАНХиГС и прошёл стажировку в Сбербанке, где занимался разработкой дашбордов и автоматизацией отчётности.

🔍 Сейчас продолжаю развивать свои навыки в аналитике, визуализации и работе с PySpark.  
📚 Также изучаю машинное обучение на базовом уровне (sklearn, statsmodels).
